                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Job Hired List</li>
                        </ol>
                    </nav>
                </div>
...
export default {
    ...
    methods: {
        async fetchData() {
            ...
            try {
                const response = await this.$axios.get(`/recruitment/getallHiredList`);
