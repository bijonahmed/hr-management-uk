                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Documents List</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="ms-auto">
                        <div class="btn-group">
                            <Nuxt-link to="/documents/new-documents"><button type="button" class="btn btn-primary"><i class="bx bx-plus"></i>New</button></Nuxt-link>
                        </div>
                    </div>
                </div>
                <!--end breadcrumb-->
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control name" placeholder="Employee Name" v-model="searchQuery.employeeName" @input="handleSearch">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="input-group mb-3">
                            ...
                            <table class="table table-hover table-sm">
                                ...
                                <tbody>
                                    <tr v-for="item in paginatedData" :key="item.id">
                                        ...
                                        <td>
                                            <center>
                                              <nuxt-link :to="{name: 'documents-edit-id', params: {id: item.id}}" variant="warning" size="sm"><i class="bx bx-edit"></i>EDIT
                                                    </nuxt-link> 
    ...
    export default {
        ...
        computed: {
            ...
            filteredData() {
                ...
                if (this.searchQuery.employeeName) {
                    result = result.filter(item =>
                        item.employeeName.toLowerCase().includes(this.searchQuery.employeeName.toLowerCase())
                    );
                }
        ...
        methods: {
            async fetchData() {
                ...
                try {
                    ...
                    const response = await this.$axios.get(`/documents/getAllDocuments`);
