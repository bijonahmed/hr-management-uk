                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item" aria-current="page">
                                <router-link to="/lead/leadList">Lead List</router-link>
                            </li>
                        ...
                        <div class="card-body">
                            <div class="border p-4 rounded">
                                ...
                                <form @submit.prevent="saveData()" id="formrest" class="forms-sample" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputEmailaddresss2" class="col-sm-3 col-form-label">addresss</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control address" v-model="insertdata.address" id="address" placeholder="addresss">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="status" v-model="insertdata.status" class="form-select">
                                                ...
                                                <option value="2">Assign to Customer</option>
...
export default {
    ...
    methods: {
        saveData() {
            ...
            this.$axios.post('/customer/saveLead',
                formData, {
                    headers
                }).then((res) => {
                $('#formrest')[0].reset();
                this.success_noti();
                this.$router.push('/lead/leadList');
        ...
        getData() {
            ...
            this.$axios.get(`/customer/getLeadRow/${id}`).then(response => {
