                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Duty Roster List</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="ms-auto">
                        <div class="btn-group">
                            <Nuxt-link to="/rota/add-duty-roster"><button type="button" class="btn btn-primary"><i class="bx bx-plus"></i>New</button></Nuxt-link>
                        </div>
                    </div>
                </div>
                <!--end breadcrumb-->
                            ...
                            <table class="table table-hover table-sm">
                                ...
                                <tbody>
                                    <tr v-for="item in paginatedData" :key="item.id">
                                        ...
                                        <td>
                                            <center>
                                                <nuxt-link :to="{name: 'rota-editDutyRoster-id', params: {id: item.id}}" variant="warning" size="sm"><i class="bx bx-edit"></i>EDIT</nuxt-link>
    ...
    export default {
        ...
        methods: {
            async fetchData() {
                ...
                try {
                    const response = await this.$axios.get(`/rota/getAllDutyRoster`);
