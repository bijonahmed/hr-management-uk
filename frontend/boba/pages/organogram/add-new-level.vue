                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item" aria-current="page">
                                <router-link to="/organogram/level-list">Organogram List</router-link>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">New Level</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
export default {
    ...
    methods: {
        saveData() {
            ...
            this.$axios.post('/organogram/saveLevel',
                formData, {
                    headers
                }).then((res) => {
                $('#formrest')[0].reset();
