        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    ...
                    <div class="ms-auto">
                        <div class="btn-group">
                            <Nuxt-link to="/organogram/organisation-hierarchy-add"><button type="button" class="btn btn-primary"><i class="bx bx-plus"></i>New</button></Nuxt-link>
                        </div>
                    </div>
                </div>
                <!--end breadcrumb-->
                            ...
                            <table class="table table-hover table-sm">
                                <thead>
                                    <tr>
                                        <th>Level</th>
                                        <th>Designation</th>
                                        <th>Name of Reporting Authority</th>
                                ...
                                <tbody>
                                    <tr v-for="item in paginatedData" :key="item.id">
                                        ...
                                        <td>{{ item.name_report_auth }}</td>
                                        <td>
                                            <center>
                                              <nuxt-link :to="{name: 'organogram-edit-id', params: {id: item.id}}" variant="warning" size="sm"><i class="bx bx-edit"></i>EDIT
                                                    </nuxt-link> 
    ...
    export default {
        ...
        computed: {
            ...
            filteredData() {
                ...
                if (this.searchQuery.level_name) {
                    result = result.filter(item =>
                        item.level_name.toLowerCase().includes(this.searchQuery.level_name.toLowerCase())
                    );
                }
                return result;
            },
        ...
        methods: {
            async fetchData() {
                ...
                try {
                    const response = await this.$axios.get(`/organogram/getOrganisationHierarchyList`);
