                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Organogram List</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
                    <div class="btn-group">
                        <Nuxt-link to="/organogram/add-new-level"><button type="button" class="btn btn-primary"><i class="bx bx-plus"></i>New</button></Nuxt-link>
                    </div>
                </div>
            </div>
            <!--end breadcrumb-->
...
export default {
    ...
    methods: {
        saveData() {
            ...
            this.$axios.post('/organogram/updateLevel',
                formData, {
                    headers
                }).then((res) => {
                this.fetchData();
                ...
                $('#myModal').modal('hide')
                this.success_noti();
                this.$router.push('/organogram/level-list');
        ...
        async fetchData() {
            ...
            try {
                ...
                const response = await this.$axios.get(`/organogram/getLevelList`);
        ...
        edit(id) {
            // alert(id);
            $('#myModal').modal('show')
            this.$axios.get(`/organogram/levelCheck/${id}`).then(response => {
