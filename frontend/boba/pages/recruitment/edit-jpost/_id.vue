                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Job Posting</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        getrow() {
            ...
            this.$axios.get(`/recruitment/checkjobpostRow/${id}`).then(response => {
                ...
                this.insertdata.job_code = response.data.data.job_code;
                ...
                this.insertdata.job_exp_min = response.data.data.job_exp_min;
                this.insertdata.job_exp_max = response.data.data.job_exp_max;
                this.insertdata.basic_salary_min = response.data.data.basic_salary_min;
                this.insertdata.basic_salary_max = response.data.data.basic_salary_max;
                this.insertdata.peroid = response.data.data.peroid;
                this.insertdata.number_of_vacanci = response.data.data.number_of_vacanci;
                this.insertdata.job_location = response.data.data.job_location;
                this.insertdata.qualification = response.data.data.qualification;
                this.insertdata.skill_set = response.data.data.skill_set;
                this.insertdata.age_min = response.data.data.age_min;
                this.insertdata.age_max = response.data.data.age_max;
                this.insertdata.gender = response.data.data.gender;
                this.insertdata.job_post_date = response.data.data.job_post_date;
                this.insertdata.job_close_date = response.data.data.job_close_date;
                this.insertdata.authrosi_officer = response.data.data.authrosi_officer;
                this.insertdata.authrosi_officer_desg = response.data.data.authrosi_officer_desg;
                this.insertdata.contact_numb = response.data.data.contact_numb;
                this.insertdata.email = response.data.data.email;
                this.insertdata.role = response.data.data.role;
                this.insertdata.lan_requirment = response.data.data.lan_requirment;
