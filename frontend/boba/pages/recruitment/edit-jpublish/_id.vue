                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Publish</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        getrow() {
            ...
            this.$axios.get(`/recruitment/checkPublishRow/${id}`).then(response => {

                console.log(`files : ${response.data.file_2}`)
