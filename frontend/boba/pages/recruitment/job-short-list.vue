                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Job Short List</li>
                            </ol>
                        </nav>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control job_title" placeholder="Job Title"
                                        v-model="searchQuery.job_title" @input="handleSearch">
                                </div>
                            </div>
                                ...
                                <tbody>
                                    <tr v-for="item in paginatedData" :key="item.id">
                                        ...
                                        <td>
                                            <center>
                                                <nuxt-link
                                                    :to="{ name: 'recruitment-seen-applied-job-id', params: { id: item.id } }"
                                                    variant="warning" size="sm"><i class="bx bx-edit"></i>EDIT
                                                </nuxt-link>
                                            </center>
                                        </td>
                                    </tr>
...
export default {
    ...
    methods: {
        async fetchData() {
            ...
            try {
                const response = await this.$axios.get(`/recruitment/getallShortListedJob`);
