                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Message Center List</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="ms-auto">
                        <div class="btn-group">
                            <Nuxt-link to="/recruitment/send-message"><button type="button" class="btn btn-primary"><i class="bx bx-plus"></i>New</button></Nuxt-link>
                        </div>
                    </div>
                </div>
                <!--end breadcrumb-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control email" placeholder="Email" v-model="searchQuery.candidate_email" @input="handleSearch">
                                </div>
                            </div>
    ...
    export default {
        ...
        computed: {
            ...
            filteredData() {
                ...
                if (this.searchQuery.candidate_email) {
                    result = result.filter(item =>
                        item.candidate_email.toLowerCase().includes(this.searchQuery.candidate_email.toLowerCase())
                    );
                }
        ...
        methods: {
            async fetchData() {
                ...
                try {
                    const response = await this.$axios.get(`/recruitment/getAllemailSending`);
